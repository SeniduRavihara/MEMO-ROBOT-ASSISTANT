...
# --- CONFIG ---
LISTEN_PORT = 8006
TEXT_TO_SAY = "How are you? I am a happy robot. And My name is mother fucker ,, how are you Damika"
VOLUME_BOOST = 1  # dB boost (0-20)
...
async def main():
    print(f"\n==========================================")
    print(f"PERSISTENT TTS SERVER STARTED (Port {LISTEN_PORT})")
    print(f"==========================================")
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
        ...
        while True:
            ...
            # Run accept in a thread to keep async loop happy if needed
            conn, addr = s.accept()
            with conn:
                print(f"Robot connected from {addr}")
                
                while True:
                    # Input is blocking, but in this simple script it's fine
